...
if __name__ == "__main__":
    ...
    if main_args.protocol[0] == "ssl":
        if main_args.bind:
            parser.add_argument("cert", type=str, nargs=1, help="path of the certificate of the ssl shell listener")
            parser.add_argument("key", type=str, nargs=1, help="path of private key of the listener's certificate")
        else:
            parser.add_argument("--cert", type=str, nargs=1, help="path of certificate of the the ssl client")
